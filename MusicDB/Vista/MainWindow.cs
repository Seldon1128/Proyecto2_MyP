...
public class MainWindow : Window
{
    public MainWindow() : base("BaseMusical")
    {
        ...
        sectionsBox.PackStart(CreateSection("Extraer Música", "Vista/images/pico.png"), true, true, 0);
        sectionsBox.PackStart(CreateSection("Directorio", "Vista/images/carpeta.png"), true, true, 0);
        sectionsBox.PackStart(CreateSection("Búsqueda", "Vista/images/lupa.png"), true, true, 0);
        sectionsBox.PackStart(CreateSection("Editar Información", "Vista/images/configuracion.png"), true, true, 0);
    ...
    private VBox CreateSection(string title, string imagePath)
    {
        ...
        sectionButton.Clicked += (sender, e) =>
        {
            if (title == "Extraer Música")
            {
                ...
                List<Song> canciones = Program.Directorio();
